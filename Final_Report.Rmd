...
breast, brain, and lung cancer [@pmc]. A 2020 DeepMind based
system outperformed human specialists in breast cancer detection, and other ML systems have reached 97% accuracy in
identifying common types of lung cancer [@pmc;@nature]. These findings
