...
We also explored bivariate EDA to examine potential interaction effects between predictors. In Figure ___, there appears to be interaction effects between each of the listed pairs of predictors since the relationships between each pair differs with the benign and malignant tumors. 
...
** LAURA INCLUDE THRESHOLD FOR PROBABILITY
** LAURA REWRITE WHATEVER NEEDS CHANGING BELOW
...
After determining the appropriate spline to be cubic splines, we set 
